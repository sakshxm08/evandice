...
const BlurCard = ({ width = "w-full", event = [] }) => {
  ...
  return (
    <div
      className={`${width} max-h-96 border border-gray-700 flex items-center justify-start gap-8 hover:gap-4 transition-all duration-500 flex-col aspect-[2/3] pt-8 pb-20 px-6 relative mx-auto rounded-2xl overflow-hidden group backdrop-blur-lg bg-blurCard`}
    >
      <img
        src={blur_card_img}
        alt="card image"
      ...
      <div className="flex flex-col w-4/5 mx-autp -mb-28 group-hover:-mb-0 transition-all duration-500">
        <Link
          to={`/events/${event._id}`}
